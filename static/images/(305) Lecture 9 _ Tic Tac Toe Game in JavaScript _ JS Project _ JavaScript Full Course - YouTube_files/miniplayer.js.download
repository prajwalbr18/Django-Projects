(function(g){var window=this;'use strict';var prb=function(a,b){g.U.call(this,{I:"button",Ma:["ytp-miniplayer-expand-watch-page-button","ytp-button","ytp-miniplayer-button-top-left"],Y:{title:"{{title}}","data-tooltip-target-id":"ytp-miniplayer-expand-watch-page-button","aria-keyshortcuts":"i","data-title-no-tooltip":"{{data-title-no-tooltip}}"},V:[{I:"svg",Y:{height:"24px",version:"1.1",viewBox:"0 0 24 24",width:"24px"},V:[{I:"g",Y:{fill:"none","fill-rule":"evenodd",stroke:"none","stroke-width":"1"},V:[{I:"g",Y:{transform:"translate(12.000000, 12.000000) scale(-1, 1) translate(-12.000000, -12.000000) "},
V:[{I:"path",Y:{d:"M19,19 L5,19 L5,5 L12,5 L12,3 L5,3 C3.89,3 3,3.9 3,5 L3,19 C3,20.1 3.89,21 5,21 L19,21 C20.1,21 21,20.1 21,19 L21,12 L19,12 L19,19 Z M14,3 L14,5 L17.59,5 L7.76,14.83 L9.17,16.24 L19,6.41 L19,10 L21,10 L21,3 L14,3 Z",fill:"#fff","fill-rule":"nonzero"}}]}]}]}]});this.J=a;this.Ra("click",this.onClick,this);this.updateValue("title",g.xU(a,"Expand","i"));this.update({"data-title-no-tooltip":"Expand"});this.addOnDisposeCallback(g.vU(b.Le(),this.element))},qrb=function(a){g.U.call(this,
{I:"div",
S:"ytp-miniplayer-ui"});this.gg=!1;this.player=a;this.T(a,"minimized",this.wh);this.T(a,"onStateChange",this.MR)},rrb=function(a){g.RV.call(this,a);
this.B=new g.aL(this);this.j=new qrb(this.player);this.j.hide();g.GU(this.player,this.j.element,4);a.jg()&&(this.load(),g.Qu(a.getRootNode(),"ytp-player-minimized",!0))};
g.w(prb,g.U);prb.prototype.onClick=function(){this.J.ib("onExpandMiniplayer")};g.w(qrb,g.U);g.k=qrb.prototype;
...
a=new prb(this.player,this);g.J(this,a);a.Ja(this.yk.element);this.wv=new g.U({I:"div",S:"ytp-miniplayer-controls"});g.J(this,this.wv);this.wv.Ja(this.yk.element);this.T(this.wv.element,"click",this.zJ);var b=new g.U({I:"div",S:"ytp-miniplayer-button-container"});g.J(this,b);b.Ja(this.wv.element);a=new g.U({I:"div",S:"ytp-miniplayer-play-button-container"});g.J(this,a);a.Ja(this.wv.element);var c=new g.U({I:"div",S:"ytp-miniplayer-button-container"});g.J(this,c);c.Ja(this.wv.element);this.CZ=new g.qX(this.player,
...
g.k.Eq=function(){};
g.k.Yw=function(){};
g.k.PN=function(){return null};g.w(rrb,g.RV);g.k=rrb.prototype;g.k.onVideoDataChange=function(){if(this.player.getVideoData()){var a=this.player.getVideoAspectRatio(),b=16/9;a=a>b+.1||a<b-.1;g.Qu(this.player.getRootNode(),"ytp-rounded-miniplayer-not-regular-wide-video",a)}};
...
g.k.unload=function(){this.player.showControls();this.j.hide()};g.QV("miniplayer",rrb);})(_yt_player);
